...
//StructuredBuffer<VSConstantBuffer0> VSConstantBuffer;
//#define mCamera VSConstantBuffer[0].mCamera
//#define mProj VSConstantBuffer[0].mProj
//#define mUVInversed VSConstantBuffer[0].mUVInversed
struct VS_Input
{
	float3 Pos		: ATTRIB0;
