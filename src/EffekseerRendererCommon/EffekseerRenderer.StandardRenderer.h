...
public:
	...
	void Rendering_(const Effekseer::Mat44f& mCamera, const Effekseer::Mat44f& mProj, int32_t bufferOffset, int32_t bufferSize, int32_t stride, int32_t renderPass)
	{
		...
		else
		{
			VertexConstantBuffer vcb;
			/*{
				Effekseer::Matrix44& ret = vcb.constantVSBuffer[0];
				const auto o = mCamera;
				Effekseer::SIMD4f::Store4(ret.Values[0], o.X);
				Effekseer::SIMD4f::Store4(ret.Values[1], o.Y);
				Effekseer::SIMD4f::Store4(ret.Values[2], o.Z);
				Effekseer::SIMD4f::Store4(ret.Values[3], o.W);
			}
			{
				const auto o = mProj;
				Effekseer::Matrix44& ret = vcb.constantVSBuffer[1];
				Effekseer::SIMD4f::Store4(ret.Values[0], o.X);
				Effekseer::SIMD4f::Store4(ret.Values[1], o.Y);
				Effekseer::SIMD4f::Store4(ret.Values[2], o.Z);
				Effekseer::SIMD4f::Store4(ret.Values[3], o.W);
